...
class Panel extends React.PureComponent {
    ...
    render() {
        let { active, renderHeader, children, prefixStyle, style, disabled } = this.props;
        active = !disabled && active;

        const itemCls = cx("jd-collapse__item", {
            "jd-collapse__item--active": active,
            "jd-collapse__item--disabled": disabled,
        });

        const headerCls = cx("jd-collapse__header", {
            "jd-collapse__header--disabled": disabled,
        });

        const contentCls = cx("jd-collapse__content", {
        ...
        return (
            <div className={itemCls} style={itemStyle}>
                ...
                >
                    ...
                    <div className="jd-collapse__content-box"  ref={(box)=>{this.box=box}}>
                        { children }
                    </div>
