...
export default class Cascader extends (PureComponent || Component) {
    ...
    _getInput = () => {
        ...
        const clearIcon = ( value.length > 0) || inputValue ? (
            <Icon
                name="close-O"
                className={`${prefix}-cascader-picker--clear`}
        ...
        const input = (
            <span className={`${prefix}-cascader-picker`}  style={this.props.style}>
                <span className={`${prefix}-cascader-picker__label`}>
                    { label }
                </span>
                <input
                    type="text"
                    readOnly={true}
                    className={`${prefix}-cascader-picker__input`}
                    autoComplete="off"
                ...
                <Icon
                    ...
                    className={`${prefix}-cascader-picker--arrow`} />
            </span>
        )
